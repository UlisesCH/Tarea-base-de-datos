...
int main()
{
	...
	mysql_init(&mysql);
	conn=mysql_real_connect(&mysql,"localhost","root","","tarea",0,0,0);
...
void cliente()
{
	...
	cout<<"Cod.cliente, Nombre, Apellido, Tel, Direccion, Correo."<<endl;
	cout<<endl;		
    ...
    //ciclo para imprimir los datos de las columnas
...
void cotizacion()
{
	...
	//Imprime lo que tiene la tabla
	cout<<"Cod.cotiza., Cod.producto, Cod.cli., Fecha.cotiza."<<endl;
	cout<<endl;	
...
void producto()
{
	...
	cout<<"Productos"<<endl;
	//Imprime lo que tiene la tabla
	cout<<"Cod.producto, Nombre, Precio."<<endl;
	cout<<endl;	
...
void venta()
{
	...
	cout<<"Ventas"<<endl;
	//Imprime lo que tiene la tabla
	cout<<"Cod.venta, Cod.produc., Cantidad, Fecha.venta, Cod.cli."<<endl;
	cout<<endl;	
	
    //Inserta para optener los datos de la tabla
    mysql_query(conn,"SELECT * FROM `venta`");
    res=mysql_store_result(conn);
